...
export function PaymentScreen({ onClose }: Readonly<PaymentScreenProps>) {
  ...
  const connectedCount = useMemo(
    () => getConnectedSchoolCount(connections),
    [connections],
  );
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <Text style={styles.introText}>
          Connect a Stripe account for each school you work with. Payouts are
          sent separately per school, so you will need to complete onboarding
          for every active school. Don&apos;t have a Stripe account?{" "}
