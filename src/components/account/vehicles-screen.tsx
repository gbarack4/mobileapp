...
import {
  cloneInstructorVehicle,
  MOCK_INSTRUCTOR_VEHICLE,
...
export function VehiclesScreen({ onClose }: VehiclesScreenProps) {
  const [vehicle, setVehicle] = useState(() => cloneInstructorVehicle(MOCK_INSTRUCTOR_VEHICLE));
  ...
  function updateField<K extends keyof InstructorVehicle>(field: K, value: InstructorVehicle[K]) {
  ...
  function handleSave() {
    ...
    // TODO: connect to NestJS instructor vehicle API
    onClose();
  }
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <Text style={styles.introText}>
          Update the car you use for lessons. Schools may show this on your instructor profile.
        </Text>
        ...
        <View style={styles.form}>
          <AuthTextField
            ...
            onBlur={() => setFocusedField((current) => (current === 'make' ? null : current))}
          ...
          <AuthTextField
            ...
            onBlur={() => setFocusedField((current) => (current === 'model' ? null : current))}
          ...
          <View style={styles.row}>
            ...
            <View style={styles.rowFieldWide}>
              <AuthTextField
                ...
                onBlur={() =>
                  setFocusedField((current) => (current === 'registration' ? null : current))
                }
                returnKeyType="done"
          ...
          <SelectionPills
            ...
            onChange={(value: TransmissionType) => updateField('transmission', value)}
          />
