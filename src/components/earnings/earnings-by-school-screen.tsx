      ...
      <View style={[styles.screen, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
        <View style={styles.header}>
          <Pressable
            ...
            style={({ pressed }: PressableState) => [styles.backButton, pressed && styles.pressed]}
          >
        ...
        <ScrollView
          ...
          <View style={styles.totalCard}>
            ...
            <Text style={styles.totalAmount}>{formatCurrency(summary.totalCents)}</Text>
          ...
          <View style={styles.schoolList}>
            {summary.schools.map((school) => {
              const sharePercent = Math.round((school.amountCents / summary.totalCents) * 100);
                ...
                <View key={school.schoolId} style={styles.schoolCard}>
                  <View style={styles.schoolTopRow}>
                    <View
                      ...
                      <Text style={[styles.schoolAvatarText, { color: school.avatarColor }]}>
                        {school.initials}
                      </Text>
                    </View>
                    ...
                    <View style={styles.schoolInfo}>
                      ...
                      <Text style={styles.schoolMeta}>
                        {school.lessonCount}{' '}
                        {school.lessonCount === 1 ? 'lesson' : 'lessons'} · {sharePercent}% of
                        weekly earnings
                      </Text>
                    </View>

                    <Text style={styles.schoolAmount}>{formatCurrency(school.amountCents)}</Text>
                  </View>
                </View>
              );
            })}
